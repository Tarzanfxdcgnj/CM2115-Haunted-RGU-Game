# Haunted RGU Campus – CM2115 Coursework

## Developer
**Bryan Adonye Pepple (Student ID: 2427924)**

## Project Description
This is a text-based adventure game built in C# using object-oriented programming.  
The player explores seven rooms within a haunted RGU campus, battling enemies and solving puzzles.

## Features
- 7 interconnected rooms
- Player health and combat system
- Enemy and puzzle challenges
- Command pattern (go, attack, solve, help, status, look, map, quit)
- Win and lose conditions
- Room factory for world building
- Exception handling and unit test structure
